...
const commonEnglishSources: readonly ElectionSource[] = [
  {
...
const commonGermanSources: readonly ElectionSource[] = [
  {
...
export const englishMessages = {
  ...
  electoralSystems: {
    ...
    methodology: {
      ...
      sourceAttribution: {
        text:
          'Election data: The Federal Returning Officer (on behalf of the publishing consortium), Wiesbaden 2024/2025. The official source data are provided under the Datenlizenz Deutschland – Namensnennung – Version 2.0 (dl-de/by-2-0). The source data were prepared, combined, statistically modelled, and partly modified for this application. The original datasets used are linked above.',
  ...
  elections: {
    selectionLabel: 'Federal election',
    modelDataSources: {
...
export type ElectionCopyCatalog = MessageCatalog['elections']
export type ElectionCopy =
  ElectionCopyCatalog['years'][keyof ElectionCopyCatalog['years']]
export type ElectionSourceCopy = ElectionCopy['sources'][number]
...
export const germanMessages: MessageCatalog = {
  ...
  electoralSystems: {
    ...
    methodology: {
      ...
      sourceAttribution: {
        text:
          'Wahldaten: Die Bundeswahlleiterin (im Auftrag der Herausgebergemeinschaft), Wiesbaden 2024/2025. Die amtlichen Ausgangsdaten stehen unter der Datenlizenz Deutschland – Namensnennung – Version 2.0 (dl-de/by-2-0). Die Ausgangsdaten wurden für diese Anwendung aufbereitet, zusammengeführt, statistisch modelliert und teilweise verändert. Die jeweils verwendeten Originaldatensätze sind oben verlinkt.',
        licenseHref: 'https://www.govdata.de/dl-de/by-2-0',
        licenseLabel:
          'Datenlizenz Deutschland – Namensnennung – Version 2.0 (dl-de/by-2-0)',
      },
